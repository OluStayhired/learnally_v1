...
const PreOrderModal: React.FC<PreOrderModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleRegisterUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        // Create a plain serializable object for email data
        const emailData = {
          to: formData.email,
          from: 'team@joinlearnally.com',
          subject: "You're In! Confirmed: Learnally Course Pre-Registration!",
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
              <h1 style="color: #3b82f6;">Welcome ${formData.firstName}!</h1>
              <p style="font-size: 16px; line-height: 1.5;">Your pre-registration for the Learnally course has been confirmed.</p>
              ...
              <p>Get ready to unlock the power of AI and gain the in-demand skills you need to build and launch amazing products to grow your business.</p>
              
              <p>This course will cover everything from Product Design with AI to Integration with ChatGPT and more.</p>

              <div style="margin: 30px 0;">
                <p style="color: #6b7280; font-style: italic;">Next Steps:</p>
        ...
        // Convert to JSON and back to ensure we have a plain object
        const serializedEmailData = JSON.parse(JSON.stringify(emailData));
        await sendEmail(serializedEmailData);
      } catch (emailError) {
